...
if (!file == ''){
    ...
    if (formdata) {
        ...
        alert("Du musst zuerst ein Foto auswählen!");
    }
}
...
function Foto2() {
file = document.getElementById("insfoto2").files[0];
if (!file == ''){
    document.getElementById("image2").src = "/images/wait.gif";

    if (window.FormData) {
        formdata = new FormData();
        document.getElementById("btnfoto2").style.display = "none";
    }
...
function Foto3() {
file = document.getElementById("insfoto3").files[0];
if (!file == ''){
    document.getElementById("image3").src = "/images/wait.gif";

    if (window.FormData) {
        formdata = new FormData();
        document.getElementById("btnfoto3").style.display = "none";
    }
