...
class CollectionTest extends TestCase {
    ...
    public function testMatch() {
        ...
        $this->assertEquals(
                [0 => $items[0], 2 => $items[2]], $matched->toArray()
        );
    ...
    public function testFirstMatch() {
        ...
        $this->assertEquals(
                ['id' => 1, 'name' => 'foo', 'thing' => ['parent_id' => 10]], $matched
        );

        $matched = $collection->firstMatch(['thing.parent_id' => 10, 'name' => 'baz']);
        $this->assertEquals(
                ['id' => 3, 'name' => 'baz', 'thing' => ['parent_id' => 10]], $matched
        );
    }
    ...
    public function testInsert() {
        ...
        $this->assertEquals(
                [['a' => 1, 'c' => 3], ['b' => 2, 'c' => 4]], iterator_to_array($iterator)
        );
    }
