...
class AuthComponentTest extends TestCase {
    ...
    public function testLogin() {
        $AuthLoginFormAuthenticate = $this->getMock(
                'Cake\Controller\Component\Auth\FormAuthenticate', array('authenticate'), array(), '', false
        );
        ...
        $this->Auth->Session = $this->getMock(
                'Cake\Controller\Component\SessionComponent', array('renew'), array(), '', false
        );
    ...
    public function testIsAuthorizedDelegation() {
        $AuthMockOneAuthorize = $this->getMock(
                'Cake\Controller\Component\BaseAuthorize', array('authorize'), array(), '', false
        );
        $AuthMockTwoAuthorize = $this->getMock(
                'Cake\Controller\Component\Auth\BaseAuthorize', array('authorize'), array(), '', false
        );
    ...
    public function testNoLoginRedirectForAuthenticatedUser() {
        ...
        $this->Auth->config('authenticate', ['Form']);
        $this->getMock(
                'Cake\Controller\Component\Auth\BaseAuthorize', array('authorize'), array(), 'NoLoginRedirectMockAuthorize', false
        );
    ...
    public function testDefaultToLoginRedirect() {
        ...
        $Controller = $this->getMock(
                'Cake\Controller\Controller', array('on', 'redirect'), array($Request, $response)
        );
    ...
    public function testRedirectToUnauthorizedRedirect() {
        ...
        $this->Auth->Session = $this->getMock(
                'Cake\Controller\Component\SessionComponent', array('setFlash'), array($Controller->components())
        );
    ...
    public function testComponentSettings() {
        ...
        $this->assertEquals(
                $expected['loginAction'], $this->Controller->Auth->config('loginAction')
        );
        $this->assertEquals(
                $expected['logoutRedirect'], $this->Controller->Auth->config('logoutRedirect')
        );
    }
    ...
    public function testLogoutTrigger() {
        $LogoutTriggerMockAuthenticate = $this->getMock(
                'Cake\Controller\Component\Auth\BaseAuthenticate', array('authenticate', 'logout'), array(), '', false
        );
    ...
    public function testMapActionsDelegation() {
        $MapActionMockAuthorize = $this->getMock(
                'Cake\Controller\Component\Auth\BaseAuthorize', array('authorize', 'mapActions'), array(), '', false
        );
    ...
    public function testFlashSettings() {
        $this->Auth->Session = $this->getMock(
                'Cake\Controller\Component\SessionComponent', array(), array(), '', false
        );
        $this->Auth->Session->expects($this->once())
                ->method('setFlash')
