...
class ControllerTest extends TestCase {
    ...
    public function testTableAutoload() {
        ...
        $this->assertInstanceOf(
                'TestApp\Model\Table\ArticlesTable', $Controller->Articles
        );
    }
    ...
    public function testLoadModelInPlugins() {
        ...
        $this->assertTrue($result);
        $this->assertInstanceOf(
                'TestPlugin\Model\Table\TestPluginCommentsTable', $Controller->TestPluginComments
        );
    }
    ...
    public function testMergeVars() {
        ...
        $this->assertEquals(
                'Posts', $TestController->modelClass, 'modelClass should not be overwritten when defined.'
        );
    }
    ...
    public function testStartupProcess() {
        ...
        $eventManager->expects($this->at(0))->method('dispatch')
                ->with(
                        $this->logicalAnd(
                                $this->isInstanceOf('Cake\Event\Event'), $this->attributeEqualTo('_name', 'Controller.initialize'), $this->attributeEqualTo('_subject', $Controller)
                        )
                )
        ...
        $eventManager->expects($this->at(1))->method('dispatch')
                ->with(
                        $this->logicalAnd(
                                $this->isInstanceOf('Cake\Event\Event'), $this->attributeEqualTo('_name', 'Controller.startup'), $this->attributeEqualTo('_subject', $Controller)
                        )
                )
                ->will($this->returnValue($this->getMock('Cake\Event\Event', null, [], '', false)));
    ...
    public function testShutdownProcess() {
        ...
        $eventManager->expects($this->once())->method('dispatch')
                ->with(
                        $this->logicalAnd(
                                $this->isInstanceOf('Cake\Event\Event'), $this->attributeEqualTo('_name', 'Controller.shutdown'), $this->attributeEqualTo('_subject', $Controller)
                        )
                )
                ->will($this->returnValue($this->getMock('Cake\Event\Event', null, [], '', false)));
