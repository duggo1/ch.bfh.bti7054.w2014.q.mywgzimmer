...
class FormHelperTest extends TestCase {
    ...
    public function testCreateIdPrefix() {
        ...
        $result = $this->Form->select(
                'Model.multi_field', ['first'], ['multiple' => 'checkbox']
        );
        $expected = [
            'input' => [
    ...
    public function testInputDatetime() {
        $this->Form = $this->getMock(
                'Cake\View\Helper\FormHelper', ['datetime'], [new View()]
        );
    ...
    public function testFormInputs() {
        ...
        $result = $this->Form->inputs(
                array('foo' => array('type' => 'text')), array('legend' => false)
        );
        $this->assertTags($result, $expected);
    }
    ...
    public function testSelectAsCheckbox() {
        $result = $this->Form->select(
                'Model.multi_field', array('first', 'second', 'third'), array('multiple' => 'checkbox', 'value' => array(0, 1))
        );
        $expected = array(
        ...
        $result = $this->Form->select(
                'Model.multi_field', array('1/2' => 'half'), array('multiple' => 'checkbox')
        );
        $expected = array(
            'input' => array('type' => 'hidden', 'name' => 'Model[multi_field]', 'value' => ''),
            array('div' => array('class' => 'checkbox')),
    ...
    public function testRadio() {
        ...
        $result = $this->Form->radio(
                'Employee.gender', array('male' => 'Male', 'female' => 'Female'), ['form' => 'my-form']
        );
        $expected = array(
    ...
    public function testSelectMultiple() {
        ...
        $result = $this->Form->select(
                'Model.multi_field', $options, ['form' => 'my-form', 'multiple' => true]
        );
        $expected = array(
            'input' => array(
                'type' => 'hidden',
        ...
        $result = $this->Form->select(
                'Model.multi_field', $options, ['multiple' => 'multiple', 'form' => 'my-form']
        );
        $this->assertTags($result, $expected);
    }
    ...
    public function testSelectMultipleCheckboxes() {
        ...
        $result = $this->Form->select(
                'Model.multi_field', array('a+' => 'first', 'a++' => 'second', 'a+++' => 'third'), array('multiple' => 'checkbox')
        );
        $expected = array(
            'input' => array(
                'type' => 'hidden', 'name' => 'Model[multi_field]', 'value' => ''
        ...
        $result = $this->Form->select(
                'Model.multi_field', array('a>b' => 'first', 'a<b' => 'second', 'a"b' => 'third'), array('multiple' => 'checkbox')
        );
        $expected = array(
            'input' => array(
                'type' => 'hidden', 'name' => 'Model[multi_field]', 'value' => ''
    ...
    public function testSelectCheckboxMultipleOverrideName() {
        ...
        $result = $this->Form->multiCheckbox(
                'category', new Collection(['1', '2']), ['name' => 'fish']
        );
    ...
    public function testPostLinkFormBuffer() {
        ...
        $result = $this->Form->postLink('Delete', '/posts/delete/2', array('block' => true, 'method' => 'DELETE')
        );
        $this->assertTags($result, array(
            'a' => array('href' => '#', 'onclick' => 'preg:/document\.post_\w+\.submit\(\); event\.returnValue = false; return false;/'),
            'Delete',
