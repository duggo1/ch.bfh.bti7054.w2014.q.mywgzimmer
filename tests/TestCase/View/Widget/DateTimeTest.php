...
class DateTimeTest extends TestCase {
    ...
    public function testRenderSelectedInvalid($selected) {
        ...
        $this->assertContains(
                sprintf($format, $now->format('Y'), $now->format('Y')), $result
        );
    }
    ...
    public function testRenderHourWidget24StartAndEnd() {
        ...
        $this->assertNotContains(
                '<option value="01">1</option>', $result, 'no 1 am'
        );
        $this->assertNotContains(
                '<option value="07">7</option>', $result, 'contain 7'
        );
        $this->assertContains(
                '<option value="13" selected="selected">13</option>', $result, 'selected value present'
        );
        $this->assertNotContains(
                '<option value="17">17</option>', $result, 'contains 17 hours'
        );
    ...
    public function testRenderHourWidget24() {
        ...
        $this->assertContains(
                '<option value="01">1</option>', $result, 'contain 1 am'
        );
        $this->assertContains(
                '<option value="05">5</option>', $result, 'contain 5 am'
        );
        $this->assertContains(
                '<option value="13" selected="selected">13</option>', $result, 'selected value present'
        );
    ...
    public function testRenderHourWidget12() {
        ...
        $this->assertContains('<select name="date[hour]" data-foo="test">', $result);
        $this->assertContains(
                '<option value="01" selected="selected">1</option>', $result, 'contain 1pm selected'
        );
        $this->assertContains(
                '<option value="05">5</option>', $result, 'contain 5'
        );
        $this->assertContains(
                '<option value="12">12</option>', $result, 'contain 12'
        );
        $this->assertNotContains(
                '<option value="13">13</option>', $result, 'selected value present'
        );
        $this->assertNotContains('date[day]', $result, 'No day select.');
        $this->assertNotContains('value="0"', $result, 'No zero hour');
    ...
    public function testRenderHourWidget12Midnight() {
        ...
        $this->assertContains(
                '<option value="12" selected="selected">12</option>', $result, '12 is selected'
        );
    }
    ...
    public function testRenderHourWidget12StartAndEnd() {
        ...
        $this->assertContains('<select name="date[hour]">', $result);
        $this->assertContains(
                '<option value="08">8</option>', $result, 'contains 8am'
        );
        $this->assertContains(
                '<option value="12">12</option>', $result, 'contains 8am'
        );
        $this->assertNotContains(
                '<option value="01">1</option>', $result, 'no 1 am'
        );
    ...
    public function testRenderMinuteWidget() {
        ...
        $this->assertContains(
                '<option value="00">00</option>', $result, 'contains 1'
        );
        $this->assertContains(
                '<option value="05">05</option>', $result, 'contains 05'
        );
        $this->assertContains(
                '<option value="25" selected="selected">25</option>', $result, 'selected value present'
        );
        $this->assertContains(
                '<option value="59">59</option>', $result, 'contains 59'
        );
    ...
    public function testRenderMinuteWidgetInterval() {
        ...
        $this->assertContains(
                '<option value="00">00</option>', $result, 'contains 0'
        );
        $this->assertContains(
                '<option value="05">05</option>', $result, 'contains 05'
        );
        ...
        $this->assertContains(
                '<option value="55">55</option>', $result, 'contains 59'
        );
    ...
    public function testRenderMinuteWidgetIntervalRounding() {
        ...
        $result = $this->DateTime->render($data);
        $this->assertContains(
                '<option value="20" selected="selected">20</option>', $result, 'selected value present'
        );
        $this->assertNotContains('value="23"', $result, 'No 23 value');
    }
    ...
    public function testMinuteIntervalHourRollover() {
        ...
        $this->assertContains(
                '<option value="00" selected="selected">00</option>', $result, 'selected minute present'
        );
        $this->assertContains(
                '<option value="10" selected="selected">10</option>', $result, 'selected day present'
        );
    }
    ...
    public function testRenderSecondsWidget() {
        ...
        $this->assertContains(
                '<option value="01">01</option>', $result, 'contains 1'
        );
        $this->assertContains(
                '<option value="05">05</option>', $result, 'contains 05'
        );
        ...
        $this->assertContains(
                '<option value="60">60</option>', $result, 'contains 60'
        );
