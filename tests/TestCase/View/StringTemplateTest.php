...
class StringTemplateTest extends TestCase {
    ...
    public function testAdd() {
        ...
        $this->assertSame(
                $this->template, $result, 'The same instance should be returned'
        );
    ...
    public function testFormatAttributesCompact() {
        ...
        $this->assertEquals(
                ' disabled="disabled" selected="selected" checked="checked" multiple="multiple"', $result
        );
    ...
    public function testFormatAttributes() {
        ...
        $result = $this->template->formatAttributes($attrs);
        $this->assertEquals(
                ' name="bruce" data-hero="&lt;batman&gt;"', $result
        );
