...
class ClientTest extends TestCase {
    ...
    public function testGetSimpleWithHeadersAndCookies() {
        ...
        $mock->expects($this->once())
                ...
                ->with($this->logicalAnd(
                                $this->isInstanceOf('Cake\Network\Http\Request'), $this->attributeEqualTo('_method', Request::METHOD_GET), $this->attributeEqualTo('_url', 'http://cakephp.org/test.html'), $this->attributeEqualTo('_headers', $headers), $this->attributeEqualTo('_cookies', $cookies)
                ))
    ...
    public function testGetQuerystring() {
        ...
        $mock->expects($this->once())
                ->method('send')
                ->with($this->logicalAnd(
                                $this->isInstanceOf('Cake\Network\Http\Request'), $this->attributeEqualTo('_method', Request::METHOD_GET), $this->attributeEqualTo('_url', 'http://cakephp.org/search?q=hi+there&Category%5Bid%5D%5B0%5D=2&Category%5Bid%5D%5B1%5D=3')
                ))
                ->will($this->returnValue([$response]));
    ...
    public function testGetWithContent() {
        ...
        $mock->expects($this->once())
                ->method('send')
                ->with($this->logicalAnd(
                                $this->isInstanceOf('Cake\Network\Http\Request'), $this->attributeEqualTo('_method', Request::METHOD_GET), $this->attributeEqualTo('_url', 'http://cakephp.org/search'), $this->attributeEqualTo('_body', 'some data')
                ))
                ->will($this->returnValue([$response]));
    ...
    public function testGetWithAuthenticationAndProxy() {
        ...
        $mock->expects($this->once())
                ->method('send')
                ->with($this->logicalAnd(
                                $this->isInstanceOf('Cake\Network\Http\Request'), $this->attributeEqualTo('_method', Request::METHOD_GET), $this->attributeEqualTo('_url', 'http://cakephp.org/'), $this->attributeEqualTo('_headers', $headers)
                ))
                ->will($this->returnValue([$response]));
    ...
    public function testMethodsSimple($method) {
        ...
        $mock->expects($this->once())
                ->method('send')
                ->with($this->logicalAnd(
                                $this->isInstanceOf('Cake\Network\Http\Request'), $this->attributeEqualTo('_method', $method), $this->attributeEqualTo('_url', 'http://cakephp.org/projects/add')
                ))
                ->will($this->returnValue([$response]));
    ...
    public function testPostWithTypeKey($type, $mime) {
        ...
        $mock->expects($this->once())
                ->method('send')
                ->with($this->logicalAnd(
                                $this->attributeEqualTo('_method', Request::METHOD_POST), $this->attributeEqualTo('_body', $data), $this->attributeEqualTo('_headers', $headers)
                ))
                ->will($this->returnValue([$response]));
    ...
    public function testCookieStorage() {
        $adapter = $this->getMock(
                'Cake\Network\Http\Adapter\Stream', ['send']
        );
    ...
    public function testHeadQuerystring() {
        ...
        $mock->expects($this->once())
                ->method('send')
                ->with($this->logicalAnd(
                                $this->isInstanceOf('Cake\Network\Http\Request'), $this->attributeEqualTo('_method', Request::METHOD_HEAD), $this->attributeEqualTo('_url', 'http://cakephp.org/search?q=hi+there')
                ))
                ->will($this->returnValue([$response]));
