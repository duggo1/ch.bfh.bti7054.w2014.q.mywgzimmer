...
class ResponseTest extends TestCase {
    ...
    public function testHeaderParsing() {
        ...
        $this->assertEquals(
                'text/html;charset="UTF-8"', $response->header('content-type')
        );
        $this->assertEquals(
                'Tue, 25 Dec 2012 04:43:47 GMT', $response->header('Date')
        );
...
XML;
    ...
    public function testCookie() {
        ...
        $this->assertEquals(
                'Wed, 09-Jun-2021 10:18:14 GMT', $result['expires']
        );
        ...
        $this->assertEquals(
                'soon', $response->cookies['expiring']['value']
        );
    }
