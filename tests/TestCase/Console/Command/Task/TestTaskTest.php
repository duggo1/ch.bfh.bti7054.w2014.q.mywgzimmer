...
class TestTaskTest extends TestCase {
    ...
    public function setUp() {
        ...
        $this->Task = $this->getMock('Cake\Console\Command\Task\TestTask', array('in', 'err', 'createFile', '_stop', 'isLoadableClass'), array($this->io)
        );
        $this->Task->name = 'Test';
    ...
    public function testExecuteWithTwoArgs() {
        $this->Task->expects($this->once())->method('createFile')
                ->with(
                        $this->stringContains('TestCase' . DS . 'Model' . DS . 'Table' . DS . 'TestTaskTagTableTest.php'), $this->stringContains('class TestTaskTagTableTest extends TestCase')
        );
