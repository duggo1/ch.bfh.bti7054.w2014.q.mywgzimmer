...
class ExtractTaskTest extends TestCase {
    ...
    public function setUp() {
        ...
        $this->Task = $this->getMock(
                'Cake\Console\Command\Task\ExtractTask', array('in', 'out', 'err', '_stop'), array($this->io)
        );
    ...
    public function testExtractExcludePlugins() {
        ...
        $this->Task = $this->getMock('Cake\Console\Command\Task\ExtractTask', array('_isExtractingApp', 'in', 'out', 'err', 'clear', '_stop'), array($this->io)
        );
