...
class PluginTaskTest extends TestCase {
    ...
    public function setUp() {
        ...
        $this->Task = $this->getMock('Cake\Console\Command\Task\PluginTask', array('in', 'err', 'createFile', '_stop', 'clear'), array($this->io)
        );
    ...
    public function testFindPathNonExistant() {
        ...
        $this->Task = $this->getMock('Cake\Console\Command\Task\PluginTask', array('in', 'out', 'err', 'createFile', '_stop'), array($this->io)
        );
        $this->Task->path = TMP . 'tests' . DS;
