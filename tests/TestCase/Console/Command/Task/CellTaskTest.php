...
class CellTaskTest extends TestCase {
    ...
    public function setUp() {
        ...
        $this->Task = $this->getMock(
                'Cake\Console\Command\Task\CellTask', ['in', 'err', 'createFile', '_stop'], [$io]
        );
    ...
    public function testMain() {
        ...
        $this->Task->expects($this->at(1))
                ->method('createFile')
                ->with(
                        $this->_normalizePath(APP . 'View/Cell/ExampleCell.php'), $this->stringContains('class ExampleCell extends Cell')
        );
    ...
    public function testMainPlugin() {
        ...
        $this->Task->expects($this->at(1))
                ->method('createFile')
                ->with(
                        $this->_normalizePath($path . 'View/Cell/ExampleCell.php'), $this->stringContains('class ExampleCell extends Cell')
        );
