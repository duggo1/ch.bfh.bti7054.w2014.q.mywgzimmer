...
class SimpleBakeTaskTest extends TestCase {
    ...
    public function setUp() {
        ...
        $this->Task = $this->getMock(
                'Cake\Console\Command\Task\SimpleBakeTask', ['in', 'err', 'createFile', '_stop', 'name', 'template', 'fileName'], [$io]
        );
        $this->Task->Test = $this->getMock('Cake\Console\Command\Task\TestTask', [], [$io]
        );
    ...
    public function testExecute() {
        $this->Task->expects($this->once())
                ->method('createFile')
                ->with(
                        $this->_normalizePath(APP . 'Model/Behavior/ExampleBehavior.php'), $this->stringContains('class ExampleBehavior extends Behavior')
        );
    ...
    public function testBakePlugin() {
        ...
        $this->Task->expects($this->once())
                ->method('createFile')
                ->with(
                        $this->_normalizePath($path . 'Model/Behavior/ExampleBehavior.php'), $this->stringContains('class ExampleBehavior extends Behavior')
        );
