...
class ViewTaskTest extends TestCase {
    ...
    protected function _setupTask($methods) {
        ...
        $this->Task = $this->getMock('Cake\Console\Command\Task\ViewTask', $methods, [$io]
        );
    ...
    public function testController() {
        ...
        $this->assertEquals(
                'TestApp\Controller\CommentsController', $this->Task->controllerClass
        );
    }
    ...
    public function testControllerPlugin() {
        ...
        $this->assertEquals(
                'TestPlugin\Controller\TestsController', $this->Task->controllerClass
        );
    }
    ...
    public function testControllerPrefix() {
        ...
        $this->assertEquals(
                'TestApp\Controller\Admin\PostsController', $this->Task->controllerClass
        );
        ...
        $this->assertEquals(
                'TestPlugin\Controller\Admin\CommentsController', $this->Task->controllerClass
        );
    }
    ...
    public function testControllerWithOverride() {
        ...
        $this->assertEquals('Comments', $this->Task->tableName);
        $this->assertEquals(
                'TestApp\Controller\PostsController', $this->Task->controllerClass
        );
    }
    ...
    public function testBakeView() {
        ...
        $this->Task->expects($this->at(0))
                ->method('createFile')
                ->with(
                        $this->_normalizePath(APP . 'Template/ViewTaskComments/view.ctp'), $this->stringContains('View Task Comments')
        );
    ...
    public function testBakeEdit() {
        ...
        $this->Task->expects($this->at(0))->method('createFile')
                ->with(
                        $this->_normalizePath(APP . 'Template/ViewTaskComments/edit.ctp'), $this->anything()
        );
    ...
    public function testBakeIndex() {
        ...
        $this->Task->expects($this->at(0))->method('createFile')
                ->with(
                        $this->_normalizePath(APP . 'Template/ViewTaskComments/index.ctp'), $this->stringContains("\$viewTaskComment->article->title")
        );
    ...
    public function testBakeActions() {
        ...
        $this->Task->expects($this->at(1))->method('createFile')
                ->with(
                        $this->_normalizePath(APP . 'Template/ViewTaskComments/edit.ctp'), $this->stringContains('Edit View Task Comment')
        );
        $this->Task->expects($this->at(2))->method('createFile')
                ->with(
                        $this->_normalizePath(APP . 'Template/ViewTaskComments/index.ctp'), $this->stringContains('ViewTaskComment')
        );
    ...
    public function testCustomAction() {
        ...
        $this->Task->expects($this->once())->method('createFile')
                ->with(
                        $this->_normalizePath(APP . 'Template/ViewTaskComments/my_action.ctp'), $this->anything()
        );
    ...
    public function testMainWithControllerFlag() {
        ...
        foreach ($views as $i => $view) {
            $this->Task->expects($this->at($i))->method('createFile')
                    ->with(
                            $this->_normalizePath(APP . 'Template/Blog/' . $view), $this->anything()
            );
        }
    ...
    public function testMainWithControllerAndAdminFlag() {
        ...
        foreach ($views as $i => $view) {
            $this->Task->expects($this->at($i))->method('createFile')
                    ->with(
                            $this->_normalizePath(APP . 'Template/Admin/Posts/' . $view), $this->anything()
            );
        }
        $this->Task->main('Posts');
    }
