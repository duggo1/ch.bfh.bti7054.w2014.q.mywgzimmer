...
class FixtureTaskTest extends TestCase {
    ...
    public function setUp() {
        ...
        $this->Task = $this->getMock('Cake\Console\Command\Task\FixtureTask', array('in', 'err', 'createFile', '_stop', 'clear'), array($io)
        );
        $this->Task->Model = $this->getMock('Cake\Console\Command\Task\ModelTask', array('in', 'out', 'err', 'createFile', 'getName', 'getTable', 'listAll'), array($io)
        );
