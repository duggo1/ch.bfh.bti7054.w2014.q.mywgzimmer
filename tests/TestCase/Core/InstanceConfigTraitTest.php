...
class InstanceConfigTraitTest extends TestCase {
    ...
    public function testDefaultsAreSet() {
        $this->assertSame(
            ...
            'some' => 'string',
            'a' => ['nested' => 'value']
                ], $this->object->config(), 'runtime config should match the defaults if not overriden'
        );
    }
    ...
    public function testGetSimple() {
        $this->assertSame(
                'string', $this->object->config('some'), 'should return the key value only'
        );

        $this->assertSame(
                ['nested' => 'value'], $this->object->config('a'), 'should return the key value only'
        );
    }
    ...
    public function testGetDot() {
        $this->assertSame(
                'value', $this->object->config('a.nested'), 'should return the nested value only'
        );
    }
    ...
    public function testSetSimple() {
        ...
        $this->assertSame(
                'bar', $this->object->config('foo'), 'should return the same value just set'
        );

        $return = $this->object->config('some', 'zum');
        $this->assertSame(
                'zum', $this->object->config('some'), 'should return the overritten value'
        );
        $this->assertSame(
                $this->object, $return, 'write operations should return the instance'
        );
        ...
        $this->assertSame(
            ...
            'a' => ['nested' => 'value'],
            'foo' => 'bar',
                ], $this->object->config(), 'updates should be merged with existing config'
        );
    }
    ...
    public function testSetNested() {
        ...
        $this->assertSame(
                'bar', $this->object->config('new.foo'), 'should return the same value just set'
        );

        $this->object->config('a.nested', 'zum');
        $this->assertSame(
                'zum', $this->object->config('a.nested'), 'should return the overritten value'
        );
    ...
    public function testMerge() {
        ...
        $this->assertSame(
            ...
            'a' => [
                ...
                ], $this->object->config(), 'Merging should not delete untouched array values'
        );
    }
    ...
    public function testMergeDotKey() {
        ...
        $this->assertSame(
            ...
            'a' => [
                ...
                ], $this->object->config(), 'Should act the same as having passed the equivalent array to the config function'
        );
    ...
    public function testSetDefaultsMerge() {
        ...
        $this->assertSame(
            ...
            'a' => [
                ...
                ], $this->object->config(), 'First access should act like any subsequent access'
        );
    }
    ...
    public function testSetDefaultsNoMerge() {
        ...
        $this->assertSame(
            ...
            'a' => [
                ...
                ], $this->object->config(), 'If explicitly no-merge, array values should be overwritten'
        );
    }
    ...
    public function testSetMergeNoClobber() {
        ...
        $this->assertSame(
            ...
            'a' => [
                ...
                ], $this->object->config(), 'When merging a scalar property will be overwritten with an array'
        );
    }
    ...
    public function testReadOnlyConfig() {
        ...
        $this->assertSame(
            ...
            'some' => 'string',
            'a' => ['nested' => 'value']
                ], $object->config(), 'default config should be returned'
        );
    ...
    public function testDeleteSimple() {
        ...
        $this->assertNull(
                $this->object->config('foo'), 'setting a new key to null should have no effect'
        );

        $this->object->config('some', null);
        $this->assertNull(
                $this->object->config('some'), 'should delete the existing value'
        );

        $this->assertSame(
                [
            'a' => ['nested' => 'value'],
                ], $this->object->config(), 'deleted keys should not be present'
        );
    }
    ...
    public function testDeleteNested() {
        ...
        $this->assertNull(
                $this->object->config('new.foo'), 'setting a new key to null should have no effect'
        );

        $this->object->config('a.nested', null);
        $this->assertNull(
                $this->object->config('a.nested'), 'should delete the existing value'
        );
