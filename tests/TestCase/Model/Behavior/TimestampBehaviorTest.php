...
class TimestampBehaviorTest extends TestCase {
    ...
    public function testGetTimestamp() {
        ...
        $this->assertInstanceOf(
                'DateTime', $return, 'Should return a timestamp object'
        );
    ...
    public function testGetTimestampPersists($behavior) {
        ...
        $this->assertSame(
                $initialValue, $postValue, 'The timestamp should be exactly the same object'
        );
    }
    ...
    public function testGetTimestampRefreshes($behavior) {
        ...
        $this->assertNotSame(
                $initialValue, $postValue, 'The timestamp should be a different object if refreshTimestamp is truthy'
        );
    }
    ...
    public function testSetTimestampExplicit() {
        ...
        $this->assertEquals(
                $ts->format('c'), $return->format('c'), 'Should return the same value as initially set'
        );
    }
    ...
    public function testTouch() {
        ...
        $this->assertSame(
                $ts->format('Y-m-d H:i:s'), $entity->modified->format('Y-m-d H:i:s'), 'Modified field is expected to be updated'
        );
    ...
    public function testTouchCustomEvent() {
        ...
        $this->assertTrue($return, 'touch is expected to return true if it sets a field value');
        $this->assertSame(
                $ts->format('Y-m-d H:i:s'), $entity->date_specialed->format('Y-m-d H:i:s'), 'Modified field is expected to be updated'
        );
        $this->assertNull($entity->created, 'Created field is NOT expected to change');
    }
