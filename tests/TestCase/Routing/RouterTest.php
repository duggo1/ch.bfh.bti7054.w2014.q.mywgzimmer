...
class RouterTest extends TestCase {
    ...
    public function testUrlGenerationNamedRoute() {
        Router::connect(
                '/users', array('controller' => 'users', 'action' => 'index'), array('_name' => 'users-index')
        );
        Router::connect(
                '/users/:name', array('controller' => 'users', 'action' => 'view'), array('_name' => 'test')
        );
    ...
    public function testUrlParsing() {
        ...
        Router::connect(
                '/posts/:value/:somevalue/:othervalue/*', array('controller' => 'posts', 'action' => 'view'), array('value', 'somevalue', 'othervalue')
        );
        ...
        Router::reload();
        Router::connect(
                '/posts/:year/:month/:day/*', array('controller' => 'posts', 'action' => 'view'), array('year' => $Year, 'month' => $Month, 'day' => $Day)
        );
        $result = Router::parse('/posts/2007/08/01/title-of-post-here');
        $expected = array(
            'year' => '2007',
        ...
        Router::reload();
        Router::connect(
                '/posts/:day/:year/:month/*', array('controller' => 'posts', 'action' => 'view'), array('year' => $Year, 'month' => $Month, 'day' => $Day)
        );
        ...
        Router::reload();
        Router::connect(
                '/posts/:month/:day/:year/*', array('controller' => 'posts', 'action' => 'view'), array('year' => $Year, 'month' => $Month, 'day' => $Day)
        );
        ...
        Router::reload();
        Router::connect(
                '/posts/:year/:month/:day/*', array('controller' => 'posts', 'action' => 'view')
        );
        $result = Router::parse('/posts/2007/08/01/title-of-post-here');
        $expected = array(
            'year' => '2007',
        ...
        Router::reload();
        Router::connect(
                '/:language/contact', array('language' => 'eng', 'plugin' => 'contact', 'controller' => 'contact', 'action' => 'index'), array('language' => '[a-z]{3}')
        );
        ...
        Router::reload();
        Router::connect(
                '/posts/:id::url_title', array('controller' => 'posts', 'action' => 'view'), array('pass' => array('id', 'url_title'), 'id' => '[\d]+')
        );
        ...
        Router::reload();
        Router::connect(
                '/posts/:url_title-(uuid::id)', array('controller' => 'posts', 'action' => 'view'), array('pass' => array('id', 'url_title'), 'id' => $UUID)
        );
    ...
    public function testUrlWritingWithPrefixesAndCustomRoutes() {
        Router::connect(
                '/admin/login', array('controller' => 'users', 'action' => 'login', 'prefix' => 'admin')
        );
        $request = new Request();
        Router::setRequestInfo(
                $request->addParams(array(
    ...
    public function testRouteRedirection() {
        ...
        $routes->get(0)->response = $this->getMock(
                'Cake\Network\Response', array('_sendHeader', 'stop')
        );
        ...
        $routes->get(0)->response = $this->getMock(
                'Cake\Network\Response', array('_sendHeader')
        );
