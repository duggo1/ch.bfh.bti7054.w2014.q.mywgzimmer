...
class RequestActionTraitTest extends TestCase {
    ...
    public function testRequestActionArray() {
        ...
        $result = $this->object->requestAction(
                array('controller' => 'request_action', 'action' => 'paginate_request_action'), array('pass' => array(5))
        );
        $this->assertNull($result);
    }
    ...
    public function testRequestActionNoPostPassing() {
        ...
        $result = $this->object->requestAction(
                array('controller' => 'request_action', 'action' => 'post_pass'), array('post' => $_POST)
        );
        $result = json_decode($result, true);
        $expected = $_POST;
        $this->assertEquals($expected, $result);
    ...
    public function testRequestActionWithQueryString() {
        ...
        $result = $this->object->requestAction(
                ['controller' => 'request_action', 'action' => 'query_pass'], ['query' => $query]
        );
        $result = json_decode($result, true);
    ...
    public function testRequestActionPostWithData() {
        ...
        $result = $this->object->requestAction(
                array('controller' => 'request_action', 'action' => 'post_pass'), array('post' => $data)
        );
        $result = json_decode($result, true);
        $this->assertEquals($data, $result);

        $result = $this->object->requestAction(
                '/request_action/post_pass', array('post' => $data)
        );
        $result = json_decode($result, true);
        $this->assertEquals($data, $result);
    }
    ...
    public function testRequestActionGetParameters() {
        ...
        $result = $this->object->requestAction(
                array('controller' => 'request_action', 'action' => 'params_pass'), array('query' => array('get' => 'value', 'limit' => 5))
        );
        $result = json_decode($result, true);
        $this->assertEquals('value', $result['query']['get']);
    }
