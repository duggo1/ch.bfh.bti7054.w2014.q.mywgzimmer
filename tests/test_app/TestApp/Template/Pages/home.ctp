...
<p>
    <?php if (file_exists(APP . 'Config/datasources.php')): ?>
...
<p>
    <?php
    echo $this->Html->link(
            '<strong>New</strong> CakePHP 2.0 Docs', 'http://book.cakephp.org/2.0/en/', array('target' => '_blank', 'escape' => false)
    );
    ?>
</p>
<p>
    <?php
    echo $this->Html->link(
            'The 15 min Blog Tutorial', 'http://book.cakephp.org/2.0/en/tutorials-and-examples/blog/blog.html', array('target' => '_blank', 'escape' => false)
    );
    ?>
</p>
