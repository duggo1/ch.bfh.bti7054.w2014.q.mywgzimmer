...
class TestTask extends BakeTask {
    ...
    public function outputTypeChoices() {
        $this->out(
                __d('cake_console', 'You must provide a class type to bake a test for. The valid types are:'), 2
        );
        $i = 0;
    ...
    public function outputClassChoices($type) {
        ...
        $this->out(
                __d('cake_console', 'You must provide a class to bake a test for. Some possible options are:'), 2
        );
    ...
    public function bake($type, $className) {
        ...
        $this->Template->set(compact(
                        'subject', 'className', 'methods', 'type', 'fullClassName', 'mock', 'realType', 'preConstruct', 'postConstruct', 'construction', 'uses', 'baseNamespace', 'subNamespace', 'namespace'
        ));
