...
class ViewTask extends BakeTask {
    ...
    protected function _methodsToBake() {
        ...
        if (class_exists($this->controllerClass)) {
            $methods = array_diff(
                    array_map('strtolower', get_class_methods($this->controllerClass)), array_map('strtolower', get_class_methods($base . '\Controller\AppController'))
            );
        }
        if (empty($methods)) {
    ...
    protected function _loadController() {
        ...
        return compact(
                'modelClass', 'schema', 'primaryKey', 'displayField', 'singularVar', 'pluralVar', 'singularHumanName', 'pluralHumanName', 'fields', 'associations', 'keyFields'
        );
    }
